...
| -------- | ---------- | -------- | -------- | ----- | -------------- |
| SWE-bench Verified | 77.2% <br> ────────── <br> 82.0% <br><sub> (паралельні обчислення) | 74.5% <br> ────────── <br> 79.4% <br><sub> (паралельні обчислення) | 72.7% <br> ────────── <br> 80.2% <br><sub> (паралельні обчислення) | 72.8% <br><sub> (GPT-5) <br> ────────── <br> 74.5% <br><sub> (GPT-5-Codex) | 67.2% | 
...
| AIME 2025 | 100% <br><sub> (python) <br> ────────── <br> 87.0% <br><sub> (без інструментів) | 78.0% | 70.5% | 99.6% <br><sub> (python) <br> ────────── <br> 94.6% <br><sub> (без інструментів) | 88.0% |
